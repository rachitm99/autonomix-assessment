...
import { Sparkles, BarChart3, Database, Zap } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Automatically extract action items with intelligent priority detection
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Tasks securely stored in MongoDB Atlas with authentication
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Visualize progress with interactive charts and priority tracking
            </p>
          </div>
        </div>
